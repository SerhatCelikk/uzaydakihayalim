...
import AppleTouch from "../assets/images/favicons/android-chrome-192x192.png";
import Fevicon32 from "../assets/images/favicons/android-chrome-192x192.png";
import Fevicon16 from "../assets/images/favicons/android-chrome-192x192.png";
  ...
  return (
    <div>
      <Head>
        ...
        <link rel="icon" type="image/png" sizes="64x64" href={Fevicon32} />
        <link rel="icon" type="image/png" sizes="32x32" href={Fevicon16} />
        <link
