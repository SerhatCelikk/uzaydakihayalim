        ...
        <Row className="align-items-center">
          <Col xl={9} lg={8}>
            <div className="call-to-action__content">
              ...
              <h3>
                We provide consultancy and <br></br> services in areas such as
                NFT,<br></br> metaverse, blockchain.
              </h3>
            </div>
          </Col>
          <Col
          ...
          >
            <Link href="https://www.valentura.com/" target="_blank">
              <a className="thm-btn ">Our Services</a>
            </Link>
          </Col>
        </Row>
      </Container>
